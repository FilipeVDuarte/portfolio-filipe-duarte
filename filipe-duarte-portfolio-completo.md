...
1. [Identidade & Contato](#identidade--contato)
2. [Sobre Mim (3 versões)](#sobre-mim)
3. [Proposta de Valor](#proposta-de-valor)
4. [Competências Técnicas](#competências-técnicas)
5. [Stack de Ferramentas](#stack-de-ferramentas)
6. [Formação Acadêmica](#formação-acadêmica)
7. [Certificações](#certificações)
8. [Experiência Profissional](#experiência-profissional)
9. [Projetos em Destaque](#projetos-em-destaque)
10. [Atividades Paralelas & Reconhecimento](#atividades-paralelas--reconhecimento)
11. [Idiomas](#idiomas)
12. [Depoimentos](#depoimentos)
13. [Próximos Passos & Em Desenvolvimento](#próximos-passos--em-desenvolvimento)
14. [Links & Contato](#links--contato)
...
**Híbrido Design + Desenvolvimento + IA.** A maioria dos designers entrega o layout no Figma. Eu entrego o produto funcionando no navegador. Domino o pipeline completo: do brief ao Figma, do Figma ao código, do código à publicação.

**Pipeline completo de produção gráfica.** Do conceito ao arquivo final pronto para impressão — gestão de perfis de cor (CMYK/RGB), sangria, margens de segurança, resolução (DPI), formatos para pré-impressão. Não preciso de revisão técnica antes de mandar pro fornecedor.

**Operador estratégico de IA.** Não uso IA como brincadeira. Uso como ferramenta de produção real — geração de assets, variações visuais, refinamento de lógica em código, assistência criativa. Reduzi tempo manual em 50%+ em projetos de grande volume.

**Autonomia comprovada sob pressão.** Quando a equipe principal se ausentou por 5 meses, assumi 100% da operação de design da Mobifans. Zero prazos perdidos. Nota de avaliação interna: **9,56/10**.
...
- Adaptação multicanal (digital, impresso, sinalização física, ambientação)
- Fechamento de arquivo para impressão (CMYK, sangria, DPI, margens de segurança, pré-impressão)
- Ilustração vetorial e tratamento de imagem
...
- Planejamento de captação e enquadramento
- Estruturação de narrativa para conteúdo curto (Reels, Shorts, TikTok)

**Produção**
- Captação de vídeo com câmera DSLR/mirrorless e smartphone profissional
- Noções de iluminação para ambientes internos e externos
- Captação de áudio para entrevistas e cobertura de eventos

**Pós-produção**
- Edição em Adobe Premiere Pro
- Motion graphics e animação em After Effects
- Color grading e tratamento de imagem
- Edição de áudio (trilhas, equalização básica, narração)
- Adaptação de formatos (9:16, 16:9, 1:1) para múltiplas plataformas

**Direção criativa para vídeo**
- Storytelling visual para conteúdo institucional e social media
- Roteirização de ganchos para conteúdo de retenção (primeiros 3 segundos)
- Acompanhamento de tendências de linguagem audiovisual

### 💻 Desenvolvimento Web

- HTML5, CSS3 e JavaScript Vanilla
- Manipulação de SVG
- Canvas API (manipulação gráfica em tempo real)
- Integração de prototipagem (Figma) com código de produção
- Performance e otimização front-end
- Deploy em plataformas modernas (Netlify)
- Workflow assistido por IA (Claude Code, Builder.io)

### 🎲 3D & Produção Física

- Modelagem 3D em Blender
- Texturização e renderização
- Planejamento de projetos para corte a laser em MDF
- Cálculo de materiais em escala e prototipagem física
- Conhecimento básico de Autodesk Maya (monitoria voluntária Senac)

### 🤖 IA Generativa & Workflow Moderno

- Uso ativo do Claude (assinatura Claude Pro)
- Engenharia de prompts para geração de assets visuais
- Geração de mockups de produto via IA
- Uso de Claude Code para assistência em desenvolvimento web
- Workflow integrado: Figma → Builder.io → código limpo
- Aceleração de criação de variações e mocks para validação rápida

### 🧭 UX/UI Design

- Design Centrado no Usuário (Curso de Extensão PUCRS, ministrado por Don Norman)
- Prototipagem em Figma
- Construção de interfaces para web (incluindo experiências em quiosques)
- Aplicação de princípios de acessibilidade
- Jornada do usuário em landing pages e eventos
- Estética Neo-Brutalista aplicada à interface

### 🧠 Soft Skills

- Autonomia sob pressão (5 meses sustentando operação inteira)
- Comunicação acessível (palestrante na 1ª Semana Conecta Unisenac)
- Capacidade de ensino (monitor voluntário por 1 ano e 8 meses)
- Atenção a detalhes (revisão cirúrgica antes de envio final)
- Colaboração com times multidisciplinares (marketing, conteúdo, liderança)
- Mentoria de estagiários e jovens aprendizes
...
|-----------|-----------|-------|
| **Design Vetorial** | Adobe Illustrator | ⭐⭐⭐⭐⭐ Avançado |
| **Tratamento de Imagem** | Adobe Photoshop | ⭐⭐⭐⭐⭐ Avançado (Certificado) |
| **Motion Graphics** | Adobe After Effects | ⭐⭐⭐⭐ Sólido |
| **Edição de Vídeo** | Adobe Premiere Pro | ⭐⭐⭐⭐ Sólido |
| **Tratamento Fotográfico** | Adobe Lightroom | ⭐⭐⭐⭐ Sólido |
...
| **Deploy** | Netlify | ⭐⭐⭐ Intermediário |
| **IA** | Claude (Pro), Claude Code | ⭐⭐⭐⭐ Uso estratégico diário |
| **Builder Visual** | Builder.io (plugin Figma) | ⭐⭐⭐ Intermediário |
...
📅 Agosto/2021 – Outubro/2024 *(Concluído)*

Formação focada em produção de mídias digitais, criação de interfaces (UX/UI) e construção de conteúdo audiovisual.

**Certificações intermediárias obtidas:**
- Diretor de Criação Multimídia (Nível Tecnológico)
- Web Designer (Nível Tecnológico)

**Competências desenvolvidas:**
Produção de conteúdo para web · Design Gráfico · Fotografia · Edição de vídeo · Texturização 3D · UX/UI

**Atividades extracurriculares:**
- Monitor voluntário em disciplinas de Adobe e Autodesk Maya (mai/2022 – dez/2023)
- Palestrante na 1ª Semana Conecta Unisenac
- Foto de fachada publicada e creditada no jornal Correio do Povo

---

### Curso de Extensão — Design Centrado no Usuário
**PUCRS — Escola Politécnica**
📅 Fevereiro/2026 | 10 horas-aula | Certificado nº 229559-2853-1

Ministrado pelos professores Marcelo Soares Pimenta e **Don Norman** (referência mundial em UX).

**Conteúdo programático:**
Diretrizes adaptativas · Pontos de partida · UX remoto · Lei de Norman · Design bom × Design ruim · Modelos conceituais · Acessibilidade · Experiência do usuário · Design e prototipação

---

### Técnico Integrado em Informática
**Escola Estadual Berilo Wanderley**
📅 Março/2018 – Abril/2021

Fundamentos de programação, desenvolvimento web (HTML/CSS/JS), banco de dados, redes e suporte técnico.
...
🏢 Adobe / Certiport
📅 Versão 24.x | Credly verificável

Exame oficial Certiport que valida domínio técnico avançado em Adobe Photoshop.
...
### 🏢 Customic / Mobifans
**Auxiliar de Marketing — Tempo Integral · Presencial**
...
**Estágio em Design de Criação · Gestão de Rede Social · Web Design · Presencial**
...
### 🎨 MobiStudio — Customizador Interativo de Capinhas
📅 Abril/2026 – Atual | 🏢 Customic

**O desafio:** Os quiosques da Mobifans não tinham uma forma otimizada de mostrar para o cliente como sua imagem ficaria aplicada à capinha. O setor de confecção também recebia referências imprecisas.

**A solução:** Desenvolvi ponta a ponta uma ferramenta web onde quiosques visualizam, junto ao cliente, a foto aplicada à capinha em tempo real — com zoom, rotação, arraste e até 6 fotos por capa.

**Como construí:**
1. Prototipagem inicial no **Figma** (interface simples, estilo Neo-Brutalista)
2. **Builder.io** como plugin para extrair estrutura visual e gerar código limpo
3. **Claude Code** para refinar a lógica do motor Canvas API (zoom, rotação, arraste fluidos)
4. Ajuste manual de HTML, CSS e JS para performance e identidade visual
5. **Migração de stack** (de tecnologia mais pesada para solução sob medida) → carregamento instantâneo
...
### 🎤 Rap In Cena — Identidade Visual de Evento
📅 Setembro/2025 – Outubro/2025 | 🏢 Mobifans em parceria com Customic

Material desenvolvido para a participação da Mobifans no **Rap in Cena**, considerado o **maior festival de Hip-Hop do Brasil**.

**Entregas:**
- Artes para redes sociais (campanhas pré-evento, durante e pós)
- Banners e peças de comunicação
- Sinalização física para o stand
- Ambientação do espaço
- Personalização de capinhas no evento (artes oficiais do festival)
- Aplicação gratuita de películas com artes do festival
...
### 🎨 Estampas Personalizadas MobiStudio
📅 Maio/2026 – Atual
...
### 📸 Foto da Fachada — Centro Universitário Senac
📅 Meados de 2023
...
### 🛠️ Trabalhos Autônomos (2020–2021)
Identidades visuais, logotipos e artes para redes sociais para pequenos negócios e criadores de diferentes segmentos no Rio Grande do Norte.

---

## 🎖️ Atividades Paralelas & Reconhecimento

### Monitor Voluntário — Centro Universitário Senac-RS
📅 Maio/2022 – Dezembro/2023 *(1 ano e 8 meses)*

Monitoria para colegas em disciplinas envolvendo Pacote Adobe e Autodesk Maya.

### Palestrante — 1ª Semana Conecta Unisenac
Workshop ministrado com atenção à acessibilidade (presença de intérprete de Libras), apresentando conteúdo da área de design de forma didática.
...
>
> — **Kamila Oliveira** · Design Gráfico, UX/UI Designer · Colega de equipe (set/2025)
...
- ✅ Vagas presenciais em Porto Alegre e Grande POA
- ✅ Modelo híbrido
- ✅ Trabalho 100% remoto
